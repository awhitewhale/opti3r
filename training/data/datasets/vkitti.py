...
from training.data.water_synthesis import load_relative_depth_map, sample_water_parameters, synthesize_underwater_image
...
class VKittiDataset(BaseDataset):
    def __init__(
        ...
        common_conf,
        split: str = "train",
        VKitti_DIR: str = "datasets/virtual_kitti",
        VKITTI_FAKE_DEPTH_DIR: str = "datasets/virtual_kitti_fake_depth_da3",
        ...
        self.fake_depth_dir = VKITTI_FAKE_DEPTH_DIR
    ...
    def get_data(
        ...
        for image_idx in ids:
            ...
            depth_fake_filepath= osp.join(self.fake_depth_dir, seq_name, f"rgb_{image_idx:05d}.jpg.npy")
            ...
            # print('depth_map',np.isnan(depth_map).any())
            ...
            # print('extrinsics1',extri_opencv.dtype)
            # print('intrinsics1',intri_opencv.dtype)
            # print('world_points1',world_coords_points.dtype)
            # print('depths1',depth_map.dtype)
