...
class TrackHead(nn.Module):
    ...
    def forward(self, aggregated_tokens_list, images, patch_start_idx, query_points=None, iters=None,frames_chunk_size=8):
        """
        ...
        feature_maps = self.feature_extractor(aggregated_tokens_list, images, patch_start_idx,frames_chunk_size=frames_chunk_size)
