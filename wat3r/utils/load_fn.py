...
import numpy as np
# from training.data.datasets.get_water_image_v2 import _depth_from_relative, _sample_betas_blue_green, \
...
def load_and_preprocess_images(image_path_list, mode="crop", target_size=518):
    ...
    # Validate mode
    if mode not in ["crop", "pad", 'max']:
        raise ValueError("Mode must be either 'crop' or 'pad' or 'max' ")
